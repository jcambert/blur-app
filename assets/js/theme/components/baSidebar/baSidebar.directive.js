...
(function () {
  ...
  /** @ngInject */
  function baSidebar($timeout, baSidebarService, baUtil, layoutSizes,appConfig) {
    var jqWindow = $(window);
    return {
      restrict: 'E',
      templateUrl: appConfig.templateThemeDirectory + '/components/baSidebar/ba-sidebar.html',
